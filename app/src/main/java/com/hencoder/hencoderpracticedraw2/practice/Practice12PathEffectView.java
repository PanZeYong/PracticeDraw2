...
public class Practice12PathEffectView extends View {
    ...
    CornerPathEffect cornerPathEffect = new CornerPathEffect(24);
    DiscretePathEffect discretePathEffect = new DiscretePathEffect(8, 8);
    DashPathEffect dashPathEffect = new DashPathEffect(new float[] {5, 8, 8, 5}, 8);
