...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        BitmapShader logoShader = new BitmapShader(logo, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        ComposeShader shader = new ComposeShader(batmanShader, logoShader, PorterDuff.Mode.DST_IN);
