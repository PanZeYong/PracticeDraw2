...
public class Practice14MaskFilterView extends View {
    ...
    BlurMaskFilter normal = new BlurMaskFilter(16, BlurMaskFilter.Blur.NORMAL);
    BlurMaskFilter inner = new BlurMaskFilter(16, BlurMaskFilter.Blur.INNER);
    BlurMaskFilter outer = new BlurMaskFilter(16, BlurMaskFilter.Blur.OUTER);
    BlurMaskFilter solid = new BlurMaskFilter(16, BlurMaskFilter.Blur.SOLID);
